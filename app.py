...
def api_manual_trade(body: dict = Body(...)):
    ...
    try:
        ...
        try:
            ...
            if side == "buy":
                _ensure_token_known(to_token, None, chain, specific_chain)
            else:
                _ensure_token_known(from_token, None, chain, specific_chain)
            # PnL ledger update
            ...
            try:
                ...
                price_from = None
            try:
                price_to = _get_price(to_token, chain, specific_chain)
            except Exception:
                price_to = None
            if side == "buy":
                ...
                if cost_usd and price_to:
                    ...
                    _ledger_buy(to_token, chain, specific_chain, amount_to=amount_to, cost_usd=cost_usd, symbol=None)
            else:
